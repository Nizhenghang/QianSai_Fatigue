...
#else
                .p_usb_apl_callback = usb_callback,
#endif
#if defined(NULL)
                .p_context = NULL,
#else
...
ceu_instance_ctrl_t g_ceu_mt9v03x_ctrl;
            const ceu_extended_cfg_t g_ceu_mt9v03x_extended_cfg =
            {
            ...
            const capture_cfg_t g_ceu_mt9v03x_cfg =
            {
                .x_capture_pixels      = 0,
                .y_capture_pixels      = 0,
                ...
                .bytes_per_pixel       = 2,
                .p_callback            = g_ceu_mt9v03x_callback,
                .p_context             = NULL,
                .p_extend              = &g_ceu_mt9v03x_extended_cfg,
            };

            const capture_instance_t g_ceu_mt9v03x =
            {
                .p_ctrl = &g_ceu_mt9v03x_ctrl,
                .p_cfg =  &g_ceu_mt9v03x_cfg,
...
ceu_instance_ctrl_t g_ceu_scc8660_ctrl;
            const ceu_extended_cfg_t g_ceu_scc8660_extended_cfg =
            {
                .capture_format       = CEU_CAPTURE_FORMAT_DATA_ENABLE,
                .data_bus_width       = CEU_DATA_BUS_SIZE_8_BIT,
                .edge_info.dsel       = 0,
            ...
            const capture_cfg_t g_ceu_scc8660_cfg =
            {
                .x_capture_pixels      = 0,
                .y_capture_pixels      = 0,
                .x_capture_start_pixel = 0,
                .y_capture_start_pixel = 0,
                .bytes_per_pixel       = 2,
                .p_callback            = g_ceu_scc8660_callback,
                .p_context             = NULL,
                .p_extend              = &g_ceu_scc8660_extended_cfg,
            };

            const capture_instance_t g_ceu_scc8660 =
            {
                .p_ctrl = &g_ceu_scc8660_ctrl,
                .p_cfg =  &g_ceu_scc8660_cfg,
                .p_api =  &g_ceu_on_capture,
            };
